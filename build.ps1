...
$taskMetadata = @{
    category = 'Channels'; changelog = 'Open the VK Videos playlists, not just the tile, in clients that only open known library types.'; description = 'Browse VK playlists and stream their videos through Jellyfin.'
